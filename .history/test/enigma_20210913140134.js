...
describe("Keyword Encoding", function() {
    ...
    describe("Encoding Test Enigma", function() {
      it("Enigma Resolution", function() {
          console.log("FELIZ DIA DE LOS PROGRAMADORES".length)
        var result = enigma.encode("FELIZ DIA DE LOS PROGRAMADORES");
        expect(result).to.equal("KJPNE INF IJ PTX UWTLWFQFITWJX");
      });
    });
  });